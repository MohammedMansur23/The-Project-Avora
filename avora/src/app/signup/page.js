    ...
    return (
      <main style={{
        ...
        <div style={{
          ...
          {error && (
            <p style={{ color: 'red', fontSize: '0.65rem', marginBottom: '1rem' }}>{error}</p>
          )}
          ...
          <p style={{ fontSize: '0.62rem', color: '#6a6a6a' }}>
            Didn't get the code?{' '}
            <span
      ...
      <div style={{
        ...
        <div style={{ background: '#fff', padding: '3rem' }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '0.65rem', color: '#0a0a0a', marginBottom: '0.4rem' }}>
              Want to sell on Avora?
            </p>
            <a href="#" style={{
              fontSize: '0.6rem',
              color: '#C9A84C',
