        ...
        <div className="right-panel">
          ...
          <button
            onClick={async () => {
              ...
              if (result.success && result.user) window.location.href = getRedirect()
            }}
          ...
          <div style={{ textAlign: 'right', marginBottom: '1.25rem' }}>
            <a href="/forgot-password" style={{ fontSize: '0.62rem', color: '#C9A84C', textDecoration: 'none' }}>
              Forgot password?
            </a>
          </div>
          ...
          <p style={{ fontSize: '0.62rem', color: '#6a6a6a', textAlign: 'center', marginTop: '1rem' }}>
            ...
            <a href="/signup" style={{ color: '#C9A84C', textDecoration: 'none', fontWeight: '600' }}>Sign Up</a>
          </p>
        </div>
      </div>
    </main>
